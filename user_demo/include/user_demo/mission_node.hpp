...
private:
    ...
    void tag_cb(const ar_track_alvar_msgs::AlvarMarkers::ConstPtr &msg)
    {
        ...
        for(int i = 0; i<count; i++)
        {
            ...
            {
                marker_found = true;
                offset_x = marker.pose.pose.position.x+0.1;
    ...
    {   
        ...
        {  
            ...
            command_state = 2;
            geometry_msgs::PoseStamped Z_goal;
            Z_goal.header.frame_id = "map";
            Z_goal.header.stamp = ros::Time::now();
            Z_goal.pose.position.x = 0.05;
            Z_goal.pose.position.y =-0.850;
            Z_goal.pose.position.z = 0;
            Z_goal.pose.orientation.x = 0;
            Z_goal.pose.orientation.y = 0;
            Z_goal.pose.orientation.z = 0;
            Z_goal.pose.orientation.w = 0.97;
            goal_pub.publish(Z_goal);
        ...
        {  
            ...
            Z_goal.header.frame_id = "map";
            Z_goal.header.stamp = ros::Time::now();
            Z_goal.pose.position.x = 0.06;
            Z_goal.pose.position.y =-2.25;
            Z_goal.pose.position.z = 0;
            Z_goal.pose.orientation.x = 0;
            Z_goal.pose.orientation.y = 0;
            Z_goal.pose.orientation.z = 0;
